...
def delete_existing_database_file
  puts "Detected existing database file. Regenerating..."
...
def generate_new_database(elements)
...
def generate_database
  if database_file_exists?
    delete_existing_database_file
  end

  generate_new_database(parse_elements)
end
...
def generate_feed
  ...
  file = File.new("#{root_path}/docset/bourbon.xml", 'w')
